// src/components/UploadIconButton.jsx
...
export default function UploadIconButton({ onFileText }) {
  ...
  return (
    <div className="flex items-center gap-3">
      {fileName && (
        <span className="text-xs text-slate-400 truncate max-w-[16rem]" title={fileName}>
          {fileName}
        </span>
      )}
      <input
      ...
      >
        {/* upload icon (lucide-like) */}
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-slate-200">
